...
//     bool _isButtonEnable = widget.emailValidator.isValid(_getEmail) &&
//         widget.passwordValidator.isValid(_getPassword) &&
//         !_isLoading;
//     return [
//       TextField(
...
//       TextButton(onPressed: _toggleFormType, child: Text(_secondaryText))
//     ];
//   }
//
//   @override
